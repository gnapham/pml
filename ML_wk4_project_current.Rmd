...
Naive Bayes trains the model quickly, but has low prediction accuracy of 0.7176.
```{r echo = T}
...
Random forest shows the best accuracy, though fitting the model is the slowest. (Code has been commented out to save time on re-running the model for report generation)
```{r eval=F, echo = T}
...
Random ferns fits a model relatively quickly and is slightly more inaccurate than random forest.
```{r echo = T}
